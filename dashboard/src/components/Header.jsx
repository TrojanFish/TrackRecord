  ...
  return (
    <header className="main-header">
      ...
      <div className="action-hub">
        ...
        <button className="icon-btn desktop-only" title="Search" style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'transparent', border: 'none', cursor: 'pointer' }}>
            <Search size={18} />
        </button>
        <button className="icon-btn desktop-only" title="Notifications" style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'transparent', border: 'none', cursor: 'pointer' }}>
            <Bell size={18} />
            <span className="notification-dot" style={{ top: '8px', right: '8px', width: '6px', height: '6px' }} />
        </button>
        <button className="icon-btn desktop-only" title="Settings" style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'transparent', border: 'none', cursor: 'pointer' }}>
            <Settings size={18} />
        </button>
        ...
        <div className="user-profile">
            <div className="avatar" title={profile?.username || 'User'} style={{ width: '32px', height: '32px', borderRadius: '10px', fontSize: '0.65rem' }}>
              {profile?.profile ? (
                ...
                profile?.username ? profile.username.substring(0, 2).toUpperCase() : 'AT'
              )}
            </div>
        </div>
      </div>
